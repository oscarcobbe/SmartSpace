...
export const PRODUCT_CATALOGUE: ShopifyProduct[] = [
  ...
  },
  {
    ...
    "description": "Our most advanced wired video doorbell gets a sleek new design featuring breakthrough 4K clarity and cutting-edge security features. Pro HDR with up to 10x Enhanced Zoom - Catch detail even at a distance with wide-angle 4K video. Live View & Two-Way Talk with Audio+ - See, hear, and speak to who's there in real time with our enhanced sound quality. 3D Motion Detection - Receive accurate alerts with radar-powered motion detection. Low-Light Sight - Get a full-colour view in low-light conditions. Ring Chime included.",
    "descriptionHtml": "<p>Our most advanced wired video doorbell gets a sleek new design featuring breakthrough 4K clarity and cutting-edge security features. Pro HDR with up to 10x Enhanced Zoom - Catch detail even at a distance with wide-angle 4K video. Live View &amp; Two-Way Talk with Audio+ - See, hear, and speak to who's there in real time with our enhanced sound quality. 3D Motion Detection - Receive accurate alerts with radar-powered motion detection. Low-Light Sight - Get a full-colour view in low-light conditions. Ring Chime included.</p>",
    "productType": "Video Doorbell",
    "tags": [
      "Doorbell",
      "Pro",
  ...
  },
  {
    ...
    "description": "Protect large outdoor areas like the driveway, back garden, or property boundary with Ring's most advanced floodlight camera. Pro HDR with up to 10x Enhanced Zoom - Catch detail even at a distance with wide-angle 4K video. Live View & Two-Way Talk with Audio+ - See, hear, and speak in real time. Low-Light Sight - Get a full-colour view in low-light conditions. Light Up Large Outdoor Areas - Give unwanted visitors nowhere to hide with 2000 lumen floodlights.",
    "descriptionHtml": "<p>Protect large outdoor areas like the driveway, back garden, or property boundary with Ring's most advanced floodlight camera. Pro HDR with up to 10x Enhanced Zoom - Catch detail even at a distance with wide-angle 4K video. Live View &amp; Two-Way Talk with Audio+ - See, hear, and speak in real time. Low-Light Sight - Get a full-colour view in low-light conditions. Light Up Large Outdoor Areas - Give unwanted visitors nowhere to hide with 2000 lumen floodlights.</p>",
    "productType": "Security Cam",
    "tags": [
      "Camera",
      "Floodlight",
