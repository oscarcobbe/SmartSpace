...
import {
  Wifi, Camera, Home, ClipboardCheck, ChevronDown, ChevronUp,
...
const HOW_IT_WORKS = [
  ...
  { n: 4, title: "We install, configure and hand over. Typically 30 minutes to 3 hours." },
...
export default function FAQPage() {
  ...
  return (
    <div className="bg-white">
      {/* ── HERO ── */}
      <section className="relative pt-32 lg:pt-40 pb-12 lg:pb-16 bg-gradient-to-b from-brand-50/40 to-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold text-[#1a1a1a] leading-[1.05] mb-5">
            Ring installation, answered.
          </h1>
          <p className="text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto">
            Everything you might want to know before booking a Ring doorbell or
            camera installation in Ireland.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            {HOW_IT_WORKS.map(({ n, title }) => (
              <div key={n} className="flex items-center gap-5 bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-br from-[#1a1a1a] to-[#2a2a2a] text-white">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-white/70 text-lg mb-8">
            ...
            answer everything in person, and send a written quote the same day.
          </p>
          <Link
