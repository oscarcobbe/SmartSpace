...
export const metadata: Metadata = {
  ...
  description:
    "Choose a Ring Video Doorbell (from €329) or External Camera (from €379) — professionally supplied and installed across Dublin and Leinster.",
  alternates: { canonical: "/services/single" },
  openGraph: {
    title: "Single Ring Device Installation | Dublin & Leinster",
    description:
      "Choose a Ring Video Doorbell from €329, or an External Camera from €379. Supplied and installed.",
